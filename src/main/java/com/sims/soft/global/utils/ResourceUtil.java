...
public class ResourceUtil {
        ...
        Map<String,String> imagePath = new HashMap<>();
            ...
            imageKey.forEach(e -> {
                ...
                if (detailImages.get(e) != null) {
                    ...
                    String location = "/images/" + id + "/" +  type + "/" + detailImages.get(e).getOriginalFilename();

                    imagePath.put(e,location);

                    String folderPath = "/images/" + id + "/" + type + "/" ;
    ...
    public static String saveFile1 (MultipartFile image, Long id,String fileType) {
...
//        List<String> imageListPath = new ArrayList<>();
        ...
        if (image != null) {
                     ...
                     location = "/files/" + id + "/" + fileType + "/" + image.getOriginalFilename();

                    String folderPath = "/files/" + id + "/" + fileType + "/" ;
    ...
    public static List<String> saveFileList (List<MultipartFile> images, Long id,String fileType) {
        ...
        if (images != null) {
            ...
            images.forEach(e -> {
                ...
                if (e != null) {
                    String location = "/files/" + id + "/" + fileType + "/" + e.getOriginalFilename();
